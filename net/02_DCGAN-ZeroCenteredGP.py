...
from models.losses.zeroCenteredGP import zeroCenteredGP
...
_C.merge_from_file(os.path.join("models", "configs", "02_DCGAN-ZeroCenteredGP.yaml"))
_C.freeze()
...
class DCGAN(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 1:
            ...
            errD = errD_real + errD_fake + 10 * zero_centered_gp
